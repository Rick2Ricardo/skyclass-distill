...
const state = {projects:[], projectId:"", videos:[], skills:[], selected:new Set(), videoSelected:new Set(), mode:"single", modality:"text", executableAssets:false, sourceMode:"remote", job:null, timer:null, documents:{}, pendingProjectId:""};
